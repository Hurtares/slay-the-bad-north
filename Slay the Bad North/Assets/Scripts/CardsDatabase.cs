...
public class CardsDatabase : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cardDb.Add(new Card(1, "Knights", "Unit of Knights", 5, 8, Card.CardType.Unit, cardKnight, unitKnight));
        cardDb.Add(new Card(2, "Lancers", "Unit of Lancers", 10, 6, Card.CardType.Unit, cardLancer, unitLancer));
        cardDb.Add(new Card(3, "Mages", "Unit of Mages", 12, 3, Card.CardType.Unit, cardMage, unitMage));
    }
